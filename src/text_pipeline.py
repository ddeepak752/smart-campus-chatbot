...
def _keyword_route(query: str) -> dict:
    ...
    routes = [
        ...
        (["civil faculty", "ce faculty", "civil staff room", "civil lecturer", "civil teacher"], "faculty_query", "civil_faculty_room", "civil faculty room"),
        (["mechanical faculty", "me faculty", "mechanical staff", "mechanical lecturer"], "faculty_query", "mechanical_faculty_room", "mechanical faculty room"),
        (["cse faculty", "computer science faculty", "cs faculty", "cs staff"], "faculty_query", "cse_faculty_room", "cse faculty room"),
        (["it faculty", "information technology faculty", "it staff"], "faculty_query", "it_faculty_room", "it faculty room"),
        (["ai faculty", "data science faculty", "ai ds faculty", "ai&ds faculty"], "faculty_query", "ai_ds_faculty_room", "ai faculty room"),
