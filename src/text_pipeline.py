...
def _keyword_route(query: str) -> dict:
    ...
    routes = [
        ...
        (["book appointment", "get appointment", "make appointment", "need appointment", "appointment"], "ask_contact", "reception", "general appointment help"),
        ...
        (["placement", "placement cell", "recruitment", "campus drive", "internship", "cv help", "career", "mock test", "mock tests", "mock interview", "mock interviews", "aptitude test", "aptitude tests"], "ask_placement", "placement_cell", "placement"),
